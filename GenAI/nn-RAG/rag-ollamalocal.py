https://ollama.com/download --> ollama pull llama3.2 --> Set up virtual environment --> pip install streamlit PyPDF2 langchain sentence-transformers faiss-cpu ollama
...
# To run the above RAG-App:
streamlit run app.py        # output on: localhost:8501)